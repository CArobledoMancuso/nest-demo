...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Error en la creación de la categoría' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 500, description: 'Error en la obtención de categorías' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Categoría no encontrada' }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Error en la actualización de la categoría' }),
    openapi.ApiResponse({ status: 200, type: require("./entities/category.entity").Category }),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Categoría no encontrada' }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Error en la eliminación de la categoría' }),
